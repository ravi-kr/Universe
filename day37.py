...
class Charm(Vocab):
    ...
    @classmethod
    def DoYourDeeds(cls) -> 'Charm':
        return cls('Do your deeds', 'Not to worry about result', 'We shall over come')
    
    @classmethod
    def MakeUsGreat(cls) -> Charm:
        return cls('Make Us Great', 'Lets make us great', 'Make us great', 'difficult', 5)
...
class Transfiguration(Vocab):
    ...
    @classmethod
    def alteraror_DE(cls):
        return cls('Make a DE', 'Lets make a DE', 'Make a DE')
    def cast(self):
        print(f"{self.incantation}")
...
class ProductManagement(Vocab):
    ...
    @classmethod
    def make_a_pm(cls):
        return cls('Make a PM', 'Lets make a PM', 'Make a PM', 'Simple')
    def cast(self):
        print(f"{self.incantation}")
...
class DataEngineer(Vocab):
    ...
    @classmethod
    def make_a_de(cls):
        return cls('Make a DE', 'Lets make a DE', 'Make a DE', 'difficult')
    def cast(self):
        print(f"{self.incantation}")
...
class SoftwareEngineer(Vocab):
    ...
    @classmethod
    def make_a_se(cls):
        return cls('Make a SE', 'Lets make a SE', 'Make a SE', 'difficult')
    def cast(self):
        print(f"{self.incantation}")
...
class CoreEngineer(Vocab):
    ...
    @classmethod
    def make_a_ce(cls):
        return cls('Make a CE', 'Lets make a CE', 'Make a CE')
    def cast(self):
        print(f"{self.incantation}")
...
class DataScientist(Vocab):
    ...
    @classmethod
    def make_a_ds(cls):
        return cls('Make a DS', 'Lets make a DS', 'Make a DS')
    def cast(self):
        print(f"{self.incantation}")

def main():
    
    charm = Charm.DoYourDeeds()
    print('charm: ', charm)
    
    transfiguration = Transfiguration.alteraror_DE()
    print(transfiguration.cast())
    
    dataengineer = DataEngineer.make_a_de()
    print('dataengineer', dataengineer)
    
    softwareengineer = SoftwareEngineer.make_a_se()
    print(softwareengineer.cast())

    datascientist = DataScientist.make_a_ds()
    print('datascientist', datascientist)

    coreengineer = CoreEngineer.make_a_ce()
    print(coreengineer.cast())
    
    productmanager = ProductManagement.make_a_pm()
    print(productmanager.cast())    
